...
const {
  FiSettings, FiZap, FiKey, FiUser, FiGlobe, FiSave, FiCheck, FiBook,
  FiShield, FiCpu, FiLink
} = FiIcons;
...
function Settings() {
  ...
  const tabs = [
    { id: 'credentials', name: 'Social Media Credentials', icon: FiShield },
    { id: 'ai-models', name: 'AI Models & Providers', icon: FiCpu },
    { id: 'webhooks', name: 'Webhooks & Integrations', icon: FiLink },
    { id: 'ai', name: 'AI Configuration', icon: FiZap },
    { id: 'content', name: 'Content Themes', icon: FiGlobe },
    { id: 'account', name: 'Account Settings', icon: FiUser }
  ];
  ...
  const brandVoices = [
    ...
    { id: 'humorous', name: 'Humorous', description: 'Fun, witty, and entertaining' },
  ...
  const postingFrequencies = [
    ...
    { id: 'twice-daily', name: 'Twice Daily', description: 'Post twice per day' },
    { id: 'weekly', name: 'Weekly', description: 'Post 3-4 times per week' },
    ...
    >
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Configure your social media credentials, AI models, webhooks, and preferences
        </p>
      </div>
      ...
      <div className="max-w-4xl">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder={formData.brandVoice === 'bible-scholar' ? "Your church or ministry name" : "Your business name"}
                />
              </div>
        ...
        {/* Save Button */}
        {activeTab !== 'credentials' && activeTab !== 'ai-models' && activeTab !== 'webhooks' && (
